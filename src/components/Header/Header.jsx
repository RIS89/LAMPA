...
const Header = () => {
  ...
  return (
    <div className="w-full h-12 bg-transparent flex items-center justify-between z-10">
      <img
        src={logo}
        alt="logo"
        className="w-10 h-10 bg-transparent ml-2.5 cursor-pointer"
        onClick={() => {
          dispatch({
      ...
      <div className="flex items-center ">
        <div className="flex  gap-x-7 mr-6">
          ...
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="stroke-zinc-50 hover:stroke-zinc-900 hover:bg-zinc-50 cursor-pointer w-8 h-8"
          >
            <path
